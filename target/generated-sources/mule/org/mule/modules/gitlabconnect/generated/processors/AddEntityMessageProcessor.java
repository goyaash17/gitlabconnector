...
package org.mule.modules.gitlabconnect.generated.processors;
...
/**
 * AddEntityMessageProcessor invokes the {@link org.mule.modules.gitlabconnect.GitlabconnectConnector#addEntity(java.lang.String, java.util.Map)} method in {@link GitlabconnectConnector }. For each argument there is a field in this processor to match it.  Before invoking the actual method the processor will evaluate and transform where possible to the expected argument type.
 * 
 */
    ...
    implements MessageProcessor, OperationMetaDataEnabled
{
        ...
        try {
            ...
            resultPayload = processTemplate.execute(new ProcessCallback<Object,Object>() {
                ...
                public Object process(Object object)
                    throws Exception
                {
                    return ((GitlabconnectConnector) object).addEntity(_transformedKey, _transformedEntity);
                }
    ...
    public Result<MetaData> getInputMetaData() {
        if (((key) == null)||((key).toString() == null)) {
            return new DefaultResult<MetaData>(null, (Result.Status.FAILURE), "There was an error retrieving metadata from parameter: key at processor addEntity at module GitlabconnectConnector");
        }
        ...
        try {
            ...
            try {
                ...
                if (metadata.get() == null) {
                    return new DefaultResult<MetaData>(null, (Result.Status.FAILURE), "There was an error processing metadata at GitlabconnectConnector at addEntity retrieving was successful but result is null");
                }
                return metadata;
            } catch (Exception e) {
