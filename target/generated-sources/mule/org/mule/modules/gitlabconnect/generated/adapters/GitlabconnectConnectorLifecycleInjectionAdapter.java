...
/**
 * A <code>GitlabconnectConnectorLifecycleInjectionAdapter</code> is a wrapper around {@link GitlabconnectConnector } that adds lifecycle methods to the pojo. This adapter also allows the injection of several Mule facilities when a MuleContext is set.
 * 
 */
@SuppressWarnings("all")
@Generated(value = "Mule DevKit Version 3.9.0", date = "2017-11-02T12:27:54-07:00", comments = "Build UNNAMED.2793.f49b6c7")
public class GitlabconnectConnectorLifecycleInjectionAdapter
    extends GitlabconnectConnectorMetadataAdapter
    implements MuleContextAware, Disposable, Initialisable, Startable, Stoppable
{
    ...
    {
        Logger log = LoggerFactory.getLogger(GitlabconnectConnectorLifecycleInjectionAdapter.class);
