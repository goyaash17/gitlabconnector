...
/**
 * A <code>GitlabconnectConnectorMetadataAdapter</code> is a wrapper around {@link GitlabconnectConnector } that adds support for querying metadata about the extension.
 * 
 */
@SuppressWarnings("all")
@Generated(value = "Mule DevKit Version 3.9.0", date = "2017-11-02T12:27:54-07:00", comments = "Build UNNAMED.2793.f49b6c7")
public class GitlabconnectConnectorMetadataAdapter
    extends GitlabconnectConnectorCapabilitiesAdapter
    implements MetadataAware
{

    private final static String MODULE_NAME = "Gitlabconnect";
